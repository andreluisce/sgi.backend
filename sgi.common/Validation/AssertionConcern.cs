...
namespace sgi.common.Validation
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentNotEmpty(string stringValue1, string stringValue2, string message)
        {
            if (stringValue1 == null || stringValue2.Trim().Length == 0)
            {
                throw new InvalidOperationException(message);
            }
        }

        public static void AssertArgumentBothNotEmpty(string stringValue1, string stringValue2, string message)
        {
        ...
        public static void AssertArgumentRange(long value, int minimum, string message)
        {
            if (value < minimum)
            {
                throw new InvalidOperationException(message);
